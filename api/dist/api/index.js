...
app.get("/api", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (query !== undefined && query.startsWith("polozky:")) {
            query = yield (0, utils_1.getFilterByPolozkyObchDokladu)(query.split("polozky:")[1]);
        }
...
app.get("/api/pdf/:id.pdf", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
